...
parser.add_argument('--dataset_code', type=str, default='UKB', choices=DATASETS.keys())
parser.add_argument('--dataset_split_seed', type=int, default=98765)
parser.add_argument('--val_set_size', type=int, default=0.05)
parser.add_argument('--test_set_size', type=int, default=0.05)
################
# Dataloader
################
...
################
parser.add_argument('--train_negative_sampler_code', type=str, default='random', choices=['popular', 'random'], help='Method to sample negative items for training. Not used in bert')
...
parser.add_argument('--test_negative_sampler_code', type=str, default='random', choices=['popular', 'random'], help='Method to sample negative items for evaluation')
